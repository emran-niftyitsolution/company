  ...
  return (
    <section className="relative min-h-[60vh] flex items-center justify-center pt-24 px-4 sm:px-6 lg:px-12 overflow-hidden bg-black">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute bottom-0 right-0 w-[800px] h-[800px] bg-gradient-to-tl from-pink-500/30 to-transparent rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }}></div>
      </div>

      <div className="relative z-10 max-w-[1600px] mx-auto w-full py-20 text-center">
        <div className="inline-block mb-6">
          <span className="text-sm font-bold text-cyan-400 uppercase tracking-wider">Case Studies</span>
        </div>
        ...
        <p className="text-xl lg:text-2xl text-gray-400 max-w-3xl mx-auto font-light">
          Discover how we&apos;ve helped companies transform their businesses with innovative software solutions
        </p>
      </div>
    </section>
  );
