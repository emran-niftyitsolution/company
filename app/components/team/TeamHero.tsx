  ...
  return (
    <section className="relative min-h-[60vh] flex items-center justify-center pt-24 px-4 sm:px-6 lg:px-12 overflow-hidden bg-black">
      ...
      <div className="absolute inset-0 z-0">
        <div className="absolute top-0 left-0 w-[600px] h-[600px] bg-gradient-to-br from-pink-500/30 to-transparent rounded-full blur-3xl animate-pulse"></div>
      ...
      <div className="relative z-10 max-w-[1600px] mx-auto w-full py-20 text-center">
        <div className="inline-block mb-6">
          <span className="text-sm font-bold text-pink-400 uppercase tracking-wider">Our Team</span>
        </div>
        ...
        <p className="text-xl lg:text-2xl text-gray-400 max-w-3xl mx-auto font-light">
          Talented individuals working together to build amazing software solutions
        </p>
      </div>
    </section>
  );
